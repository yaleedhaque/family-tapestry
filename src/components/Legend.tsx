      ...
      {open && (
        <>
          ...
          <div className="px-4 py-3 space-y-3">
            <div>
              <div className="text-[10px] uppercase tracking-wider text-[var(--thread-gold-dim)] mb-1.5">Ring colour = status</div>
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-[11px] text-[var(--parchment-dim)] font-body">Divorced</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-[var(--thread-gold-dim)]/15 pt-2.5 space-y-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] text-[var(--parchment-dim)] font-body">Marriage / partnership</span>
              </div>
              <div className="flex items-center gap-2">
